...
2. Go to **Settings** of your newly created repository, scroll down to **GitHub Pages** and chose **main branch/docs folder** (see more details in the [Docsify documentation](https://docsify.now.sh/deploy?id=gitlab-pages))
