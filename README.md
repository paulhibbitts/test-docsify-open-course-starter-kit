...
4. Find the line `var gitLinkRepoURL = '';` and enter the URL of your own GitHub Repository (replace `github.com` with `github.dev` to use the GitHub.dev web-based editor currently in Beta) between the two quotes and then scroll down to the bottom of the page and tap the **Commit changes** button to save your changes
